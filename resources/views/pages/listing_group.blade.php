           ...
           {{-- <div class="date-colps">
            ...
            <div class="row">
                        ...
                        <div class="navbar navbar-default" role="navigation">
                            ...
                            <div class="sbar navbar-collapse collapse sidebar-navbar-collapse">
                                ...
                                <div class="collapse-group">
                                    <input type="hidden" value="{{$query_for}}" name="query_for" />
                ...
                <div class="col-md-9 pdl" id="table_data">
                    ...
                    @include('pages.pagination_data_group')
...
@section('pagespecificscripts')
    <script>
        ...
        function fetch_data_group(page)
        {   
            $.ajax({
                url:"/fetch_data_group?page="+page,
